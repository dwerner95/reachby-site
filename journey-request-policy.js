...
(function installReachByJourneyRequestPolicy(root) {
  ...
  const SENSITIVE_NOTES = /\b(?:PNR|BOOKING|RESERVATION|TICKET|PAYMENT|CARD|PASSPORT|PASSWORD|SECRET|TOKEN|DIAGNOSIS|MEDICAL|HEALTH|DISABILITY|DISABLED|WHEELCHAIR|ACCESSIBILITY|BLIND|DEAF)(?:[-_ ]?(?:NUMBER|NO|REFERENCE|REF|CODE|ID))?\b/i;
